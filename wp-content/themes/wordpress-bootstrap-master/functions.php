...
################################################################################
add_action('init', 'ufofactory_register_custom_post');
################################################################################

function ufofactory_register_custom_post() {
  register_post_type( 'politics',
    array(
      'labels' => array(
        'name' => __( '정치' ),
        'singular_name' => __( '정치' ),
        'add_new' => __( '새로 추가하기' ),
        'add_new_item' => __( '새 정치 추가' ),
        'edit_item' => __( '정치 수정' ),
        'new_item' => __( '새 정치' ),
        'view_item' => __( '정치 보기' ),
        'search_items' => __( '정치 찾기' ),
        'not_found' => __( '정치를 찾을 수 없음' ),
        'not_found_in_trash' => __( '휴지통에서 정치를 찾을 수 없음' )
      ),
      'public' => true,
      'supports' => array( 'title', 'editor', 'thumbnail', 'comments', 'custom-fields' ),
      'capability_type' => 'post',
      'rewrite' => array("slug" => "politics"), // Permalinks format
      'menu_position' => 4,
      'has_archive'   => true,
