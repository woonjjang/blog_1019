					    ...
					    <div class="singlebox">
		                    <?php jovial_breadcrumbs() ?>
								...
								<nav id="image-navigation" class="site-navigation">
                                    <span class="previous-image"><?php previous_image_link( true, __( '<< Previous', 'jovial' ) ); ?></span>
                                    <span class="next-image"><?php next_image_link( true, __( 'Next >>', 'jovial' ) ); ?></span>
